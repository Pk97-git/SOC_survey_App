__d(function (global, require, _$$_IMPORT_DEFAULT, _$$_IMPORT_ALL, module, exports, _dependencyMap) {
  ...
  var _schema = require(_dependencyMap[1]);
  ...
  const getDb = async () => {
    ...
    const isExpoGo = Constants.default.executionEnvironment === _expoConstants.ExecutionEnvironment.StoreClient;
    {
      // Mock DB for web and Expo Go
      // Data will be stored in AsyncStorage via storage.ts
      console.warn(`SQLite not supported (${'web'}). Using AsyncStorage.`);
      dbInstance = {
        execAsync: async () => {},
        runAsync: async () => {},
        getAllAsync: async () => [],
    ...
    try {
      const SQLite = await require(_dependencyMap[4])(_dependencyMap[3], _dependencyMap.paths, "expo-sqlite");
      dbInstance = await SQLite.openDatabaseAsync('facility_survey.db');
      await (0, _schema.migrateDb)(dbInstance);
      return dbInstance;
    } catch (e) {
...
},961,{"0":1,"1":962,"2":819,"3":963,"4":823,"paths":{"963":"/_expo/static/js/web/index-90b9d74f378742796f5ee8861df8afdf.js"}});
__d(function (global, require, _$$_IMPORT_DEFAULT, _$$_IMPORT_ALL, module, exports, _dependencyMap) {
  "use strict";
  ...
  Object.defineProperty(exports, "migrateDb", {
    enumerable: true,
    get: function () {
      return migrateDb;
    }
  ...
  `);
     ...
     */
    const addColumnIfNotExists = async (table, column, typeDef) => {
