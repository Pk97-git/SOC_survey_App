        ...
        return (
            <View style={styles.compactContainer}>
                <View style={[styles.statusDot, {
                    backgroundColor: syncStatus.isOnline ? Colors.status.successGreen : Colors.status.errorRed
                }]} />
        ...
        <Surface style={[styles.container, { backgroundColor: theme.colors.surfaceVariant }]} elevation={1}>
            <View style={styles.content}>
                <View style={styles.statusRow}>
                    ...
                    <Text style={{
                        color: syncStatus.isOnline ? Colors.status.successGreen : Colors.status.errorRed,
                        fontWeight: '700',
                        fontSize: 12
                    }}>
