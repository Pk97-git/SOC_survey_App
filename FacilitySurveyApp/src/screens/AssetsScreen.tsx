...
export default function AssetsScreen() {
    ...
    const handleBulkImport = async () => {
        ...
        try {
            ...
            // Refresh the list immediately — do NOT rely on Alert callbacks (browsers can
            // block window.confirm() / window.alert() after a long async operation).
            loadAssetsForSite(selectedSite);

            // Single-button alert maps to window.alert() on web, which is never blocked.
            Alert.alert(
                'Import Successful',
